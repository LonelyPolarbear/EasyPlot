...
int main() {
	...
	app.addCmd("test_lerp_rgb", u8"颜色线性插值",test_lerp_rgb);
	app.addCmd("test_combineArray", u8"合并数组", test_combineArray);
	app.addCmd("test_linespace", u8"线性空间", test_linespace);
